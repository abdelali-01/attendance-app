        ...
        <div className="relative hidden overflow-hidden rounded-[24px] bg-white shadow-[0_8px_30px_rgba(16,24,40,0.08)] ring-1 ring-slate-100 lg:block">
          ...
          <div className="relative z-10 p-8">
            ...
            <p className="mt-3 max-w-md text-slate-600">
              Track attendance, view analytics, and keep your class organized. Your data
              is secured with enterprise‑grade practices.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Fast Attendance</div>
                <div className="mt-1 text-xs text-slate-600">Mark students present in seconds.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Smart Insights</div>
                <div className="mt-1 text-xs text-slate-600">Spot trends and engage early.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Secure by Design</div>
                <div className="mt-1 text-xs text-slate-600">Privacy-first, reliable uptime.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Works Anywhere</div>
                <div className="mt-1 text-xs text-slate-600">Responsive on any device.</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-[24px] bg-white p-6 shadow-[0_8px_30px_rgba(16,24,40,0.08)] ring-1 ring-slate-100">
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-end">
                <a href="/forgot-pass" className="text-sm font-semibold text-[#5A57FF] hover:underline">Forgot password?</a>
              </div>
              ...
              <div className="mt-6 text-center text-sm text-slate-600">
                ...
                <a href="/signup" className="font-semibold text-[#5A57FF] hover:underline">Sign up</a>
              </div>
            </form>
          </div>
        </div>
