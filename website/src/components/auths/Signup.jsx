        ...
        <div className="relative hidden overflow-hidden rounded-[24px] bg-white shadow-[0_8px_30px_rgba(16,24,40,0.08)] ring-1 ring-slate-100 lg:block">
          ...
          <div className="relative z-10 p-8">
            ...
            <p className="mt-3 max-w-md text-slate-600">
              Sign up to track attendance, share analytics, and collaborate with your
              students seamlessly.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Easy Onboarding</div>
                <div className="mt-1 text-xs text-slate-600">Set up your classes in minutes.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Always Secure</div>
                <div className="mt-1 text-xs text-slate-600">Your data stays protected.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Collaborative</div>
                <div className="mt-1 text-xs text-slate-600">Invite teachers and students.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-inset ring-slate-200 backdrop-blur">
                <div className="text-sm font-semibold text-slate-900">Reliable</div>
                <div className="mt-1 text-xs text-slate-600">99.9% uptime infrastructure.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto w-full max-w-md self-center">
          <div className="rounded-[24px] bg-white p-6 shadow-[0_8px_30px_rgba(16,24,40,0.08)] ring-1 ring-slate-100">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate-600">It only takes a minute to get started.</p>
            </div>

            <form onSubmit={handleSubmit} className="mt-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex flex-col gap-2">
                  <label htmlFor="name" className="text-sm font-medium text-slate-700">First Name</label>
                  <input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="familyName" className="text-sm font-medium text-slate-700">Last Name</label>
                  <input
                    id="familyName"
                    name="familyName"
                    type="text"
              ...
              {user.role === "student" && (
                <div className="mt-4 flex flex-col gap-2">
                  <label htmlFor="matricule" className="text-sm font-medium text-slate-700">Matricule Number</label>
                  <input
              ...
              <div className="mt-6 text-center text-sm text-slate-600">
                ...
                <a href="/login" className="font-semibold text-[#5A57FF] hover:underline">Log in</a>
              </div>
            </form>
          </div>
        </div>
