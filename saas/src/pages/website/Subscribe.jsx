      ...
      >
        <div className="text-center">
          ...
          <p className="text-secondary mb-4">
            The free plan doesn't require a subscription. You can start using it
            immediately.
          </p>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            ...
            <div className="text-center mb-5">
              ...
              <p className="fs-5 text-secondary">{planDetails.description}</p>
            </div>
              ...
              <div className="alert alert-info mb-4" role="alert">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <br />
                    <small>
                      Plan: {pendingSubscription.plan} | Duration:{" "}
                      {pendingSubscription.duration} months | Amount:{" "}
                      {pendingSubscription.amount} DA
                    </small>
                  </div>
                  <button
